...
import org.ot.authserver.dao.AuthorizationRepository;
import org.ot.authserver.entity.AuthUser;
import org.ot.authserver.entity.Authority;
import org.ot.authserver.entity.Authorization;
import org.ot.authserver.entity.UserPrincipal;
import org.ot.authserver.mixin.AuthUserMixin;
import org.ot.authserver.mixin.AuthorityMixin;
import org.ot.authserver.mixin.SetMixin;
import org.ot.authserver.mixin.UserPrincipalMixin;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
	...
	public JpaOAuth2AuthorizationService(AuthorizationRepository authorizationRepository, RegisteredClientRepository registeredClientRepository) {
		...
		this.objectMapper.addMixIn(AuthUser.class, AuthUserMixin.class);
		this.objectMapper.addMixIn(Authority.class, AuthorityMixin.class);
		this.objectMapper.addMixIn(PersistentSet.class, SetMixin.class);
	}
